import "./add_document_criterion_page_component.css";
...
const AddDocumentCriterionPage = () => {
    ...
    const handleSubmit = async(event: any) => {
        ...
        let criterionToRegister = new DocumentCriterion(0, clientId, criterionName);

        criteriaService.registerDocumentCriterion(criterionToRegister)
        .then((response) => {
    ...
    return (
        <div id="addcp-add-criterion-container">
            <div id="addcp-welcome-panel">
                <h1>WELCOME TO</h1>
                <Figure>
                    <Figure.Image
                        width={250}
                ...
                <h3>{clientName}</h3>
                <h3>New document-based criterion</h3>
            </div>
            <Card id="addcp-add-criterion-card">
                <Card.Body>
                    <Form noValidate onSubmit={handleSubmit}>
                        ...
                        <div id="addcp-add-criterion-card-button-panel">
                            <Button className="addcp-add-criterion-card-button-panel-button" variant="dark"  onClick={() => {navigate(-1)}}>Back</Button>
                            <Button type="submit" className="addcp-add-criterion-card-button-panel-button" variant="dark">Submit</Button>
                        </div>
                    </Form>
...
export default AddDocumentCriterionPage;